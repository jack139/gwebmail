  ...
  if (dofolder()==-1)
    {
      ...
      fprintf(cgiOut, "<title>Add Folder</title></head>\n");
...
int dofolder()
{
  ...
  result=cgiFormStringNoNewlines("afolder", folder_n, 30);
  ...
  sprintf(temp, "select count(*) from folder"
